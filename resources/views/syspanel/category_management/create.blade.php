...
@section('page_title', 'Kategori Ekleme')
@section('content')
            ...
            <div class="grid lg:grid-cols-12 gap-5">
                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    ...
                    <div class="card p-5">
                        ...
                        <button type="button" onclick="core_form('{{route('category-management-create-p')}}', 2, '{{route('category-management-create')}}');" class="btn btn_primary uppercase">Kategori Oluştur <i class="fa-solid fa-circle-notch fa-spin" style="display:none;margin-left:5px;"></i> </button>
